...
namespace DS_ConsoleApp_ReportStatusExport
{
    ...
    class ReportStatusExport
    {
        ...
        public static void CheckDir(string CheckPath, int DaysNumber,  DB_Write mongoDB_Test)
        {
            try
            {
                //Check folders
        ...
        public static void CheckFiles(string d, int DaysNumber, DB_Write mongoDB_Test)
        {
