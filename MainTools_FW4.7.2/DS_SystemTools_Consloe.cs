...
namespace DS_SystemTools
{
    public class DS_Tools
    {
        ...
        public void DS_StreamWriter(string OutputTxt, bool Add = true)
        {
            ...
            {
                Console.WriteLine("Error access to path!");
                return;
            }
        ...
        {
            if (Directory.Exists(DS_LogOutputPath + DS_LogName))
            {
                Console.WriteLine("Output file has been saved to: " + DS_LogOutputPath + DS_LogName);
            }
        }
